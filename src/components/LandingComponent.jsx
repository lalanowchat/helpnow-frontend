...
export default function LandingComponent({ onNeedHelp, onWantToHelp, onLogoClick, activeDropdown }) {
    ...
    return (
        <>
            <Header title="HelpNow Inc" onNeedHelp={onNeedHelp} onWantToHelp={onWantToHelp} onLogoClick={onLogoClick} activeDropdown={activeDropdown} />
